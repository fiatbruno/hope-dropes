...
// ====================================================================================================================
	 ...
	 * @public static
	 */
	public static function UTF8StringToArray($str, $isunicode=true, $currentfont=true) {
		if ($isunicode) {
	 ...
	 * @public static
	 */
	public static function UTF8ToLatin1($str, $isunicode=true, $currentfont=true) {
	 ...
	 * @public static
	 */
	public static function UTF8ToUTF16BE($str, $setbom=false, $isunicode=true, $currentfont=true) {
		if (!$isunicode) {
	 ...
	 * @public static
	 */
	public static function utf8StrRev($str, $setbom=false, $forcertl=false, $isunicode=true, $currentfont=true) {
	 ...
	 * @public static
	 */
	public static function utf8StrArrRev($arr, $str='', $setbom=false, $forcertl=false, $isunicode=true, $currentfont=true) {
	 ...
	 * @public static
	 */
	public static function utf8Bidi($ta, $str='', $forcertl=false, $isunicode=true, $currentfont=true) {
