          ...
          <table class="table table-hover table-striped text-nowrap w-100" id="table_example">
            ...
            <tbody>
              ...
              ?><tr>
                  ...
                  <td><a class="btn btn-outline-primary" href="<?= base_url() ?>Mail/sendMail?id=<?= $id ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Send Mail</a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
