...
<nav class="navbar navbar-light bg-light p-3">
	...
	<div class="col-12 p-3 container-fluid row justify-content-center">
		<div class="col-6 shadow-lg p-5 mt-3">
        <?php
        ...
        ?>
			<form class="rounded mt-2 needs-validation" novalidate action="#" method="POST">
				...
				<div class="mb-3 mt-2 row">
					...
					<input type="email" class="form-control w-75" name="to_mail" id="exampleFormControlInput1" placeholder="name@example.com" required>
				...
				<div class="mb-3 mt-2 row">
					...
					<input type="text" class="form-control w-75" name="from_mail" id="exampleFormControlInput1" placeholder="dr. Donatien" required>
					<div class="invalid-feedback">
						Please enter a valid email!
					</div>
				</div>
				<div class="mb-3 mt-2 row">
					...
					<textarea type="text" class="form-control w-75 h" name="message" style="width: 100px" id="exampleFormControlInput1" placeholder="The response to the donnor...." required></textarea>
					<div class="invalid-feedback">
						Message is required!
					</div>
				</div>
